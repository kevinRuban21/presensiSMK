                ...
                <div class="col-lg-7">
                    <div class="contact-from mt-30">
                        <div class="section-title">
                            <div class="row">
                                <div class="col"><h5>Presensi Masuk</h5></div>
                            </div>
                        </div> <!-- section title -->
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="singel-form form-group">
                                            <input type="password" name="id_siswa" id="scan_masuk" placeholder="Scan disini">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#presensi_form').submit(function(e) {
                e.preventDefault();
                $.ajax({
                    url: '<?= base_url('PresensiMasuk/SimpanData') ?>',
                    type: 'POST',
                    data: $(this).serialize(),
        ...
        function presensi(){
            $.ajax({
                url: '<?= base_url('PresensiMasuk/PresensiBaru') ?>',
                type: 'GET',
                success: function(response) {
